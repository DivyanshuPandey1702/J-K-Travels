...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGl2eWFuc2h1cGFuZGV5MTcwMiIsImEiOiJja3d6OHo0czgwZmo0MnZueTQ1dWlqbGdrIn0.LSqlNwbWv9NdY9Dh47Q90g';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/divyanshupandey1702/ckwzay4ma0uqw14o7duwoljsn',
    // style URL
    scrollZoom: false
  });
...
var updateSetting = document.querySelector('.form-user-data');
...
if (updateSetting) {
  updateSetting.addEventListener('submit', function (e) {
    e.preventDefault();
